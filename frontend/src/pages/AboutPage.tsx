            ...
            <div className={styles.heroSection}>
                <div className={styles.heroContent}>
                    ...
                    <p className={styles.heroSubtitle}>
                        Revolutionizing eye tracking technology for accessible, accurate, and affordable vision assessment
                    </p>
                </div>
            </div>
            ...
            <div className={styles.contentSection}>
                <div className={styles.missionCard}>
                    ...
                    <p className={styles.sectionText}>
                        At zapgaze, we believe that advanced eye tracking technology should be accessible to everyone.
                        Our platform combines cutting-edge computer vision algorithms with user-friendly interfaces to
                        provide accurate eye tracking and vision assessment tools that work with standard webcams.
                    </p>
                </div>
                ...
                <div className={styles.featuresGrid}>
                    <div className={styles.featureCard}>
                        ...
                        <p className={styles.featureText}>
                            Powered by state-of-the-art computer vision and machine learning algorithms
                            that deliver precise eye tracking results.
                        </p>
                    </div>
                    ...
                    <div className={styles.featureCard}>
                        ...
                        <p className={styles.featureText}>
                            No expensive hardware required. Our solution works with standard webcams
                            found in most computers and laptops.
                        </p>
                    </div>
                    ...
                    <div className={styles.featureCard}>
                        ...
                        <p className={styles.featureText}>
                            Achieve professional-grade eye tracking accuracy through our advanced
                            calibration and tracking algorithms.
                        </p>
                    </div>
                    ...
                    <div className={styles.featureCard}>
                        ...
                        <p className={styles.featureText}>
                            Access our platform from any device with a modern web browser.
                ...
                <div className={styles.technologySection}>
                    ...
                    <div className={styles.techGrid}>
                        <div className={styles.techItem}>
                            ...
                            <p className={styles.techDescription}>React, TypeScript, and modern CSS for responsive design</p>
                        </div>
                        <div className={styles.techItem}>
                            <h4 className={styles.techTitle}>Backend</h4>
                            <p className={styles.techDescription}>Python FastAPI with real-time WebSocket communication</p>
                        </div>
                        <div className={styles.techItem}>
                            <h4 className={styles.techTitle}>Eye Tracking</h4>
                            <p className={styles.techDescription}>MediaPipe, PyGaze, and custom computer vision algorithms</p>
                        </div>
                        <div className={styles.techItem}>
                            <h4 className={styles.techTitle}>Database</h4>
                            <p className={styles.techDescription}>SQLite with SQLAlchemy ORM for data persistence</p>
                        </div>
                    </div>
                </div>
